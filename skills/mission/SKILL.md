...
- **Pages:** after a milestone lands, a blocker flips, or a review concludes — spawn **reporter**, and, when a finding lands, the story page via `/review` and the front door's learned/now lines. Reporter commits, never pushes.
